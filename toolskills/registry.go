...
// Provision implements core.Provisioner — currently a no-op stub.
// A real implementation would install skill tooling into a sandbox.
func (r *Registry) Provision(_ interface{}, skill core.SkillMeta) error {
	// Future: copy skill files, install deps, etc.
	return nil
}
